package com.mercadolivre.checkoutexample.util

import android.content.Context
import android.os.Parcel
import android.os.Parcelable
import androidx.fragment.app.DialogFragment
import com.mercadolivre.checkoutexample.ui.fragment.CustomDialogFragment
import com.mercadolivre.checkoutexample.model.CustomSplitPaymentProcessor
import com.mercadolivre.checkoutexample.services.PaymentServiceMock
import com.mercadolivre.checkoutexample.ui.fragment.CongratsCustomTopFragment
    ...
    companion object{
        ...
        private fun getCharges(addChargeToCreditCard: Boolean): MutableList<PaymentTypeChargeRule> {
            ...
            charges.add(PaymentTypeChargeRule.createChargeFreeRule(
                ...
                "Esta opção é sem encargos extras"))
        ...
        private fun getCustomStringConfiguration() = CustomStringConfiguration.Builder()
            .setCustomPayButtonText("Realizar Pagamento customizado")
            .setCustomPayButtonProgressText("Processando pagamento... aguarde ...")
            .setTotalDescriptionText("Valor a pagar customizado:")
            .build()
    }
}
